...
import { EVM_NETWORKS, NATIVE_COIN, NATIVE_COIN_SYMBOL, NETWORK_TYPE } from "../../../config/network";
...
export const SelectNetwork = observer(() => {
    ...
    return <Screen style={ { minHeight: "100%" } } preset={ "scroll" } backgroundColor={ Colors.bg }
        ...
        <ItemSelector labelTransform={ (i) => i.name === "mainnet" ? "ETHEREUM" : i.name.toUpperCase() } selected={ getEVMProvider().currentNetworkName } items={ view.networks }
