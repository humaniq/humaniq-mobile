...
export const TabsScreen = observer<ITabsScreenProps>((props) => {
    ...
    return <View style={ { minHeight: "100%" } }>
        <Ripple testID={ 'openNewTab' } rippleColor={ Colors.primary } onPress={ () => props.newTab() }
                style={ {
                        ...
                        >
                            <View row spread centerV paddingH-10 width={ "100%" } style={ { zIndex: 20 } }
                                ...
                                <View paddingL-10 style={ { width: "70%" } }>
                                    <Text robotoM numberOfLines={ 1 }
                                          color={ props.activeTab === tab.id ? Colors.white : Colors.black }>
                                        { isHomepage ? t("browserScreen.newTab") : hostname }
                                    </Text>
                                </View>
                                <Ripple testID={ `closeTab-${ index }` }
                                        onPress={ () => props.closeTab(tab.id) } rippleColor={ Colors.primary }
